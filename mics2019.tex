...
Since Clojure is very simple in its syntax and immutability-based semantics and runs on the JVM, it would be ideal to teach in an introductory level programing course, similar to 
the Racket-based Beginner Student languages, also in a Lisp category~\cite{{htdp}.
The simplicity allows focus on functional decomposition, and the use of the JVM provides a connection to subsequent Java-based courses. 
